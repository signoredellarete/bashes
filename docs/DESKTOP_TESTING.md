...
- The Tunnel action opens a panel for a SOCKS proxy tunnel using the selected resource and keeps the tunnel active from that panel without opening a terminal tab.
